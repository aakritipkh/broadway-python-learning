...
# Boolean type in python is the subclass of the Integer class where False represents O and True represents 1.
...
# All the empty datatypes, Non and False are Falsy values
