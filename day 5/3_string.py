...
# Escape characters are the characters in python which suppress the actual python meaning and gives new meaning to that character.
...
# Triple quoted strings are not only used as normal strings, but are also used to add code descriptions in functions, classes and as multiline comments
