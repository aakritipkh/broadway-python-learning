...
print(v1.doors)  # bike  # get_data
print(v1.color)  # red  # get_data
...
v2_changed_colour = Vehicle(8, "blue")
print(v2_changed_colour.color)




# function inside a class is called the method of that class and that can be called with the object of that class only
