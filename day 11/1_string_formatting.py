...
age = int(input("Enter your age")) # age = input("Enter your age") this is for f string method
...
message = "I have {}, and {} in my bag.".format('book', 'pen', 'copy')
print(message)  # here first placeholder takes 'book', second placeholder takes 'pen' and the others are ignored\
