...
# if conditions always takes truthy or falsy statement. If the statement is truthy the block inside if condition is
# executed. If falsy the block inside if is not executed
